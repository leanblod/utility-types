...
type JsonParsable = JsonObject | JsonArray | JsonLiterals | JsonString;
...
// TODO - Parser for JSON string literal
// type JsonParse<Json extends string> = Json extends JsonStringify<infer JS extends JsonParsable> ? JS : never;
